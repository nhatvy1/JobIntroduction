    ...
    <div class="container mt-100">
        <form action="">
            <div class="row">
                ...
                <!--                <div class="col-md-3">
                                    <div class="form-group">
                                        <select class="form-control w-100 mb-20" path="userRole" id="userRole">
                                            <option value="1">Người xin việc</option>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <input value="Tìm kiếm" type="submit" class="form-control w-50 text-center text-dark"/>
                    </div>
                </div>
            </div>
        </form>
                        ...
                        <div class="single-listing">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdownCus dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <a class="dropdown-item" href="<c:url value="/jobs"/>" />Tất cả</a>
                                    <c:forEach items="${jobCategories}" var="jobCate">
                                        <c:url value="/jobs" var="action">
                                            <c:param name="cateId" value="${jobCate.id}"/>
                                        </c:url>
                                        ...
                                        <div class="single-job-items mb-30">
                                            <div class="job-items">
                                                <div class="company-img">
                                                    <a href="<c:url value="/postingDetail/${p.id}" />"><img class="anh borderAnh" src="<c:url value="${p.image}"/>" alt="${p.name}"></a>
                                                </div>
